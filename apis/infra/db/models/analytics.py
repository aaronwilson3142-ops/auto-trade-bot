...
class SecurityFeatureValue(Base, TimestampMixin):
    ...
    feature_value_numeric: Mapped[Optional[Decimal]] = mapped_column(sa.Numeric(20, 8), nullable=True)
    feature_value_text: Mapped[Optional[str]] = mapped_column(sa.Text, nullable=True)
    source_version: Mapped[Optional[str]] = mapped_column(sa.String, nullable=True)
