...
Last Updated: 2026-06-01 10:08 UTC — **RED Mon pre-market probe (5:08 AM CT). First trading day back after 4.5-day machine outage (May 26–31).** 8/8 containers Up 16h healthy. /health 7/7 ok. 0 crash-triad. Pytest 360p/0f ✓. CI run 26721931587 on bf771eb conclusion=success ✓. All APIS_* flags correct ✓. job_count=36 ✓. **Bars FRESH**: bars caught up to 2026-05-29 (last Fri trading day) at AM ingestion. Signals/rankings stale (2026-05-26) — self-heal at 10:30/10:45 UTC today (Y1 expected). **R1 CARRY-FORWARD**: 5 dup OPEN pairs (AMD×2/AMZN×2/INTC×2/MRVL×2/MU×2) — Phase 85 fix still pending; first Mon cycle 13:35 UTC resumes risk. **R2 UNCONFIRMED**: ghost Alpaca positions (QCOM/TXN/CSCO/ARM/STX) — watch Mon c1 13:35 UTC logs for broker_health_position_drift. Portfolio: cash=$52,730.07 equity=$121,985.86 (last snapshot May 26). eval_runs=112 ✓. RED email sent. **Action required from Aaron**: (1) HIGH RED — Phase 85 `_persist_positions` code fix; (2) HIGH RED — DB cleanup SQL (AMD Apr29, AMZN Apr29, INTC May1, MU May1, MRVL May19); (3) MEDIUM — watch Mon c1 for R2 ghost positions.
