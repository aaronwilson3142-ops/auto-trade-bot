...
class ApiAppState:
    ...
    ranking_as_of: Optional[dt.datetime] = None

    # --- Portfolio -------------------------------------------------------
    portfolio_state: Optional[Any] = None                       # PortfolioState | None
    ...
    execution_engine: Optional[Any] = None      # ExecutionEngineService | None

    # --- Evaluation ------------------------------------------------------
    latest_scorecard: Optional[Any] = None                     # DailyScorecard | None
    evaluation_run_id: Optional[str] = None
    evaluation_history: list[Any] = field(default_factory=list)

    # --- Reports ---------------------------------------------------------
    latest_daily_report: Optional[Any] = None                  # DailyOperationalReport | None
    ...
    # --- Paper trading loop ----------------------------------------------
    broker_adapter: Optional[Any] = None            # BaseBrokerAdapter | None
    paper_loop_active: bool = False
    last_paper_cycle_at: Optional[dt.datetime] = None
    paper_cycle_results: list[Any] = field(default_factory=list)  # list[dict]

    # --- Live mode gate --------------------------------------------------
    live_gate_last_result: Optional[Any] = None     # LiveModeGateResult | None
    ...
    broker_auth_expired_at: Optional[dt.datetime] = None
    ...
    kill_switch_activated_at: Optional[dt.datetime] = None
    kill_switch_activated_by: Optional[str] = None   # source IP or "env"
    ...
    last_snapshot_equity: Optional[float] = None
    ...
    last_sod_capture_date: Optional[dt.date] = None
    ...
    last_signal_run_id: Optional[str] = None      # UUID string of last SignalRun persisted
    last_ranking_run_id: Optional[str] = None     # UUID string of last RankingRun persisted
    ...
    alert_service: Optional[Any] = None           # WebhookAlertService | None
    ...
    active_weight_profile: Optional[Any] = None   # WeightProfileRecord | None
    ...
    current_regime_result: Optional[Any] = None   # RegimeResult | None
    ...
    correlation_computed_at: Optional[dt.datetime] = None
    ...
    liquidity_computed_at: Optional[dt.datetime] = None
    ...
    latest_var_result: Optional[Any] = None        # VaRResult | None
    var_computed_at: Optional[dt.datetime] = None
    ...
    latest_stress_result: Optional[Any] = None     # StressTestResult | None
    stress_computed_at: Optional[dt.datetime] = None
    ...
    latest_signal_quality: Optional[Any] = None   # SignalQualityReport | None
    signal_quality_computed_at: Optional[dt.datetime] = None
    ...
    latest_earnings_calendar: Optional[Any] = None  # EarningsCalendarResult | None
    earnings_computed_at: Optional[dt.datetime] = None
    ...
    drawdown_state_changed_at: Optional[dt.datetime] = None
    ...
    rebalance_computed_at: Optional[dt.datetime] = None
    ...
    universe_computed_at: Optional[dt.datetime] = None
    ...
    latest_factor_exposure: Optional[Any] = None   # FactorExposureResult | None
    factor_exposure_computed_at: Optional[dt.datetime] = None
    ...
    last_auto_execute_at: Optional[dt.datetime] = None
    ...
    fill_quality_summary: Optional[Any] = None     # FillQualitySummary | None
    fill_quality_updated_at: Optional[dt.datetime] = None
    ...
    latest_readiness_report: Optional[Any] = None   # ReadinessReport | None
    readiness_report_computed_at: Optional[dt.datetime] = None
    ...
    #   Persists for the lifetime of the process (reset on restart).
    last_dominant_factor: Optional[str] = None
    ...
    fill_quality_attribution_summary: Optional[Any] = None   # AlphaDecaySummary | None
    fill_quality_attribution_updated_at: Optional[dt.datetime] = None
